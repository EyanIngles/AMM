...
async function main() {
    ...
    console.log(`Investor 2 swapping Ease -> Dapp tokens...\n`)
    //investor approves tokens
    transaction = await Ease.connect(investor2).approve(amm.address, tokens(10))
    await transaction.wait()
    //swapping token
    ...
    console.log(`Investor 3 swapping Dapp -> Ease tokens...\n`)
    //investor approves tokens
    ...
    console.log(`Investor 4 swapping Dapp -> Ease tokens...\n`)
    //investor approves tokens
    transaction = await Ease.connect(investor4).approve(amm.address, tokens(10))
    await transaction.wait()
