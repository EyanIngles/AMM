...
contract AMM {
    ...
    function swapDapp(uint256 _token1Amount) external returns(uint256 token2Amount) {
    ...
    //swap token 1 function
    function swapEase(uint256 _token2Amount) external returns(uint256 token1Amount) {
