...
describe('AMM', () => {
    ...
    describe('Swapping tokens', () => {
        it('filicates swaps', async () => {
            ...
            console.log((await token1.balanceOf(amm.address)).toString())
            console.log((await token2.balanceOf(amm.address)).toString())
            console.log((await liquidityProvider.balanceOf(amm.address)).toString())
        })
    })
})