...
describe('AMM', () => {
    ...
    describe('Swapping tokens', () => {
        it('filicates swaps', async () => {
            ...
            transaction = await token1.connect(liquidityProvider).approve(amm.address, tokens(50000))
            await transaction.wait()
            transaction = await token2.connect(liquidityProvider).approve(amm.address, tokens(50000))
            await transaction.wait()
