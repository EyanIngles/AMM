...
export const loadTokens = async (provider, chainId, dispatch) => {
    const Dapp = new ethers.getContract(config[chainId].Dapp.address, TOKEN_ABI, provider)
    const Ease = new ethers.getContract(config[chainId].Ease.address, TOKEN_ABI, provider)
